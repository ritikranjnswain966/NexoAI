    ...
    <div>
      {message.role === "user" ? (
        <div className='flex items-start justify-end my-4 gap-2'>
          <div className='flex flex-col gap-2 p-2 px-4 bg-indigo-50/60 dark:bg-[#001a09]/40 border border-indigo-100 dark:border-[#00FF41]/10 rounded-md max-w-2xl'>
      ...
      :
      (
        <div className='inline-flex flex-col gap-2 p-2 px-4 max-w-2xl bg-violet-50/50 dark:bg-[#00FF41]/5 border border-violet-100 dark:border-[#00FF41]/10 rounded-md my-4'>
          {message.isImage ? (
